...
## See https://github.com/antimattercorrade/Pan_Tompkins_QRS_Detection/blob/main/README.md      
class Pan_Tompkins_QRS():
    ...
    def derivative(self, signal, sampling_frequency):
        '''
        Derivative Filter 
        :param signal: input signal
        :return: prcoessed signal
        ...
        for index in range(len(signal)):
            ...
            result[index] = (result[index]*sampling_frequency)/8
    ...
    def moving_window_integration(self,signal, sampling_frequency):
        '''
        ...
        result = signal.copy()
        win_size = round(0.150 * sampling_frequency)
        sum = 0 
